...
The `instruqt-go` maintainers take all security issues in the project
seriously. Thank you for improving the security of `instruqt-go`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`instruqt-go` leverages GitHub's private vulnerability reporting.
